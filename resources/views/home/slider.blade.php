        ...
        <div class="single-slider slider-screen nrbop bg-black-alfa-40" style="background-image: url({{ asset('img/slides/s1.jpg')}});">
            <div class="container">
                <div class="slider-content text-white">
                    ...
                    <div class="slider_button b_faddown3"><a href="#">Conheça</a></div>
                </div>
            </div>
        </div>
        <div class="single-slider slider-screen nrbop bg-black-alfa-40" style="background-image: url({{ asset('img/slides/s1.jpg')}});">
            <div class="container">
                <div class="slider-content text-white">
                    ...
                    <p class="b_faddown2">Lorem ipsum dolor sit amet consecte tur adipiscing titor sit amet consecte tur adipiscing titor
                        <br />a accumsan justo laoreetsit amet consecte tur adipiscing titor </p>
                    <div class="slider_button b_faddown3"><a href="#">Conheça 1</a></div>
                </div>
            </div>
        </div>
        <div class="single-slider slider-screen nrbop bg-black-alfa-40" style="background-image: url({{ asset('img/slides/s1.jpg')}});">
            <div class="container">
                <div class="slider-content text-white">
                    ...
                    <p class="b_faddown2">Lorem ipsum dolor sit amet consecte tur adipiscing titor sit amet consecte tur adipiscing titor
                        <br />a accumsan justo laoreetsit amet consecte tur adipiscing titor </p>
                    <div class="slider_button b_faddown3"><a href="#">Conheça 2</a></div>
                </div>
            </div>
        </div>
    </div>
